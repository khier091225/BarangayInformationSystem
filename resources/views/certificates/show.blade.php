...
<html lang="en">
    <head>
        ...
        <title>{{ $certificate->certificate_type }} - {{ $certificate->resident->full_name }}</title>
        @fonts
    ...
    <body class="workspace-page">
        ...
        <aside class="workspace-sidebar no-print">
        ...
        <div class="workspace-shell">
            ...
            <main class="workspace-main" style="padding: 30px;">
