        ...
        <div class="workspace-shell">
            ...
            <main class="workspace-main" style="padding: 24px 34px; max-width: 800px;">
                <div style="margin-bottom: 24px;">
                    ...
                    <p style="color: #69786b; font-size: 13px;">I-update ang status ng pagdinig o baguhin ang mga tala.</p>
                </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 18px;">
                            ...
                            <div>
                                ...
                                <select name="status" required style="width: 100%; padding: 10px 12px; border: 1px solid #ccd5c8; border-radius: 6px; font-size: 13px; background: white; box-sizing: border-box;">
                                    <option value="Pending" {{ old('status', $blotter->status) == 'Pending' ? 'selected' : '' }}>Pending (Kasalukuyang dinidinig)</option>
                                    <option value="Settled" {{ old('status', $blotter->status) == 'Settled' ? 'selected' : '' }}>Settled (Nagkasundo na)</option>
                                    <option value="Dismissed" {{ old('status', $blotter->status) == 'Dismissed' ? 'selected' : '' }}>Dismissed (Kanselado/Ibinasura)</option>
                                </select>
